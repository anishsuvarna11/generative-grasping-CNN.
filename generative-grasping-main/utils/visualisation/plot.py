...
def plot_results(
    ...
    if len(gs) > 0:
        # print(gs[0].center, gs[0].angle, gs[0].length, gs[0].width)
        distance = depth_frame.get_distance(*gs[0].center)
        print("distance: ", distance)
      
        
        color_pixel = gs[0].center
        depth_min = 0.07 #meter
        ...
        if depth_pixel != [-1,-1]:
            ...
            print("3d coordinate for center: ", (x_depth_point, y_depth_point, z_depth_point))
