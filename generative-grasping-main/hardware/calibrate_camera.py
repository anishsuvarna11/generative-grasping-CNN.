...
class Calibration:
    ...
    def _generate_grid(self):
        ...
        """
        gridspace_x = np.linspace(int(self.workspace_limits[0][0]), int(self.workspace_limits[0][1]),
                                  int(1 + (self.workspace_limits[0][1] - self.workspace_limits[0][
                                      0]) / self.calib_grid_step))
        gridspace_y = np.linspace(int(self.workspace_limits[1][0]), int(self.workspace_limits[1][1]),
                                  int(1 + (self.workspace_limits[1][1] - self.workspace_limits[1][
                                      0]) / self.calib_grid_step))
        gridspace_z = np.linspace(int(self.workspace_limits[2][0]), int(self.workspace_limits[2][1]),
